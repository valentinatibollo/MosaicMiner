...
8) Copy the mosaicminer_testpage.html in var/www/html
9) In MM_VM in /usr/lib/cgi-bin/  copy these files: main_find_history_opt_new_json_inout_file and run_matlab.sh
